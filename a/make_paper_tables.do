...
table_from_tpl, t($datafp/covid_como_sumstats_tpl.tex) r($tmp/covid_como_sumstats.csv) o($outputs/covid_como_sumstats.tex)

/* create the risk table 2 */
table_from_tpl, t($datafp/covid_como_sumhr_tpl.tex) r($tmp/covid_como_sumstats.csv) o($outputs/covid_como_sumhr.tex)

/* create the age-specific prevalence appendix table */
table_from_tpl, t($datafp/covid_como_agerisks_tpl.tex) r($tmp/covid_como_agerisks.csv) o($outputs/covid_como_agerisks.tex)

/* create the o/s vs. england  prevalence appendix table */
table_from_tpl, t($datafp/covid_como_oscompare_tpl.tex) r($tmp/covid_como_sumstats.csv) o($outputs/covid_como_oscompare.tex)
