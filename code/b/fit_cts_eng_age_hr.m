...
writematrix([age predicted_hr_age_sex predicted_hr_full],'tmp/eng_age_fits.csv')

%% prepend a header to the file
system('echo "age,ln_hr_age_sex,ln_hr_full" > tmp/eng_age_predicted_hr.csv');
system('cat tmp/eng_age_fits.csv >> tmp/eng_age_predicted_hr.csv');
fprintf("Writing eng_age_predicted_hr.csv\n");
